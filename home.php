...
<body style="background-image: url('/ONLINE_QUIZ/image/IITB-lc-lh-l.jpeg'); background-size: cover; background-repeat: no-repeat; background-attachment: fixed; background-position: center;">
    <?php 
    include 'nav_bar.php';
    ?>
